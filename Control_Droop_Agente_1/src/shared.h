 ...
 */
/* Ubicación de polos (2.º orden) — el usuario elige frecuencia natural y
 * amortiguamiento de cada lazo. recomputeGains() deriva Kp/Ki:
...
extern volatile float zetaV;    // ζ lazo voltaje  (amortiguamiento)
